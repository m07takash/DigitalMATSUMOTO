...
- [Chat タブのその他の機能](#chat-タブのその他の機能)
  ...
  - [セッションサマリー（ユーザー定義のセッション状態文書）](#セッションサマリーユーザー定義のセッション状態文書)
...
- [API リファレンス](#api-リファレンス)
  ...
  - [セッションサマリー API（`/sessions/{id}/summary` / `/session_summary_presets`）](#セッションサマリー-apisessionsidsummary--session_summary_presets)
  - [実行例](#実行例)
...
### セッションサマリー API（`/sessions/{id}/summary` / `/session_summary_presets`）
